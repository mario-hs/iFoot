...
public class IfootApplication implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		Espaco espaco1 = new Espaco(null, "Bom Gosto", "94767172000103", "Linha Amarela", "bomgosto@gmail.com", "123");
		...
		// PELADA
		Pelada pelada1 = new Pelada(null, new Date(122, 5, 10, 21, 00, 00), reservaGrupo1);
		peladaRepository.saveAll(Arrays.asList(pelada1));
		Pelada pelada2 = new Pelada(null, new Date(122, 5, 17, 21, 00, 00), reservaGrupo2);
