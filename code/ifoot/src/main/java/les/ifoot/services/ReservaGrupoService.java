...
public class ReservaGrupoService {
    ...
    public ReservaGrupo findById(Integer idCampo, Integer idHorario){
        ...
        try {
            ...
            throw new ObjectNotFoundException("Objeto não encontrado! Id: " + id + ", Tipo: " + ReservaGrupo.class.getName(), ReservaGrupo.class.getName());
        }
    }
    ...
    // public Collection<ReservaGrupo> findAll() {
        ...
        public ReservaGrupo insert(ReservaGrupo obj) {
            try {
                ...
                throw new DataIntegrityException("Campo(s) obrigatório(s) da ReservaGrupo não foi(foram) preenchido(s): CampoHorario (Campo e/ou Horario)");
            }
        }
