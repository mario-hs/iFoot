...
public class TransferirDinheiroService {
    ...
    public boolean validaTransacao(Integer idJogador, TransferirDinheiro obj){
        ...
        // System.out.println(repository.findByTransferenciaValorJogador(aux[0], idJogador));
        ...
        if (valorTotal > 50) {
            throw new BusinessRuleException("Ao fazer esta transferencia voce supera o limtie diario. Você ainda pode transferir " + valorTransferir + " reias hoje");
        }
